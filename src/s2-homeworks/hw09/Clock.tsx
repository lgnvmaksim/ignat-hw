...
function Clock() {
    ...
    const start = () => {
     stop()
        const id:number= +setInterval(()=>{setDate(new Date())}, 0)
        setTimerId(id)
    ...
    const stringTime = date.toLocaleTimeString('ru', {timeStyle:'short'}) || <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
    const stringDate = date.toLocaleDateString('ru', {dateStyle:'short'}) || <br/> // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
